...
- **Root README as Hub:** If a project root `README.md` exists (repo root `README.md` and `projects/HOON/README.md`), it **MUST contain explicit markdown links to all of its direct part `README.md` files** so navigation is obvious without guessing. Repo root links to `projects/HOON/README.md`, `projects/HOON/spec-tests/README.md`, `projects/HOON/implementations/c/README.md`, `projects/HOON/implementations/cpp/README.md`, `projects/HOON/implementations/python/README.md`, `agents/repo-linter/README.md`. Project root `projects/HOON/README.md` links to `spec-tests/README.md` and each `implementations/<lang>/README.md`. The linter **warns** if these hub links are missing.
